"""Export current quality contracts without replacing historical phase snapshots."""
import json
...
(root/'docs/phase08-4b-host-openapi.json').write_text(json.dumps(create_app(None).openapi(),indent=2)+'\n')
